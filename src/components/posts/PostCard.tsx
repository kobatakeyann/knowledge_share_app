...
import { POST_TYPE_LABELS, MOOD_LABELS } from "../../types";
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          {post.mood && (
            <span className="text-base" title={MOOD_LABELS[post.mood]}>
      ...
      {canPromote && (
        ...
        >
          <span>⭐</span>
          <span>ナレッジ化する</span>
          <span className="text-amber-500/60">({totalReactions} reactions)</span>
        </button>
      )}
    </article>
  );
