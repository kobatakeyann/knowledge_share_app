...
const navItems = [
  ...
  { to: "/feed", label: "フィード", icon: "📋" },
  { to: "/users", label: "メンバー", icon: "👥" },
];
      ...
      <div className="p-3 border-t border-white/5">
        ...
        >
          ...
          <div className="min-w-0">
            <div className="text-sm font-medium text-gray-200 truncate">{currentUser.name}</div>
            <div className="text-xs text-gray-500">貢献度: {currentUser.contributions}</div>
          </div>
        </Link>
      </div>
    </aside>
