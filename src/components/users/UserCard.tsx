	...
	return (
		...
		>
			...
			<div className="flex items-center gap-3">
				<Link to={`/knowledge_share_app/profile/${user.id}`}>
				...
				<div className="min-w-0 flex-1">
					<Link
						to={`/knowledge_share_app/profile/${user.id}`}
						className="text-sm font-semibold text-gray-100 hover:text-white transition-colors block"
					>
						{user.name}
					</Link>
